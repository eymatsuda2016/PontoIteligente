package com.eduardomatsuda.pontointeligente.api.controllers;
...
import com.eduardomatsuda.pontointeligente.api.dtos.CadastroPJDto;
...
import com.eduardomatsuda.pontointeligente.api.response.Response;
import com.eduardomatsuda.pontointeligente.api.services.EmpresaService;
import com.eduardomatsuda.pontointeligente.api.services.FuncionarioService;
...
public class CadastroPJController {
	...
	private void validarDadosExistentes(CadastroPJDto cadastroPJDto, BindingResult result) {
		...
		.ifPresent (emp -> result.addError(new ObjectError("empresa", "Empresa já foi cadastrada.")));
		
		this.funcionarioService.buscarPorCpf(cadastroPJDto.getCpf())
		.ifPresent(func -> result.addError(new ObjectError("funcionario", "CPF já foi cadastrada.")));
